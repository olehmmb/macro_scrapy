...
class TableSpider(scrapy.Spider):
    ...
    def start_requests(self) -> Generator[Any, Any, Any]:
        ...
        urls = {
            'MFCR_state_deficit': {
                url: 'https://www.mfcr.cz/cs/rozpoctova-politika/statni-rozpocet/plneni-statniho-rozpoctu',
                xpath: [
                    '(//a[contains(@href, "mesicni-pokladni-plneni")])[1]/@href',
                    '(//a[contains(@href, "mesicni-pokladni-plneni") and count(@*) = 1])[position()  <= 7]/@href',
                    ],
                'xpath_table': ['(//tbody)[1]/tr'],
                },
            'CNB_EUR_CZK': {
                url: 'https://www.cnb.cz/cs/financni-trhy/devizovy-trh/kurzy-devizoveho-trhu/kurzy-devizoveho-trhu/prumerne_mena.html?mena=EUR',
                xpath: [],
