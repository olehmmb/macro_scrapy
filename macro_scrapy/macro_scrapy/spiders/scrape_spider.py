    ...
    def start_requests(self) -> Generator[Any, Any, Any]:
        urls = {
            ...
            "Households_Debt.csv":{"url":"https://stats.oecd.org/SDMX-JSON/data/NAAG/.DBTS14_S15NDI/OECD?contentType=csv",
                                   "xpath":""},
            "Households_DisposableIncome_Q.csv":{"url":"https://stats.oecd.org/SDMX-JSON/data/DP_LIVE/CZE.HHDI.GROSS.PC_CHGPPCAP.Q/OECD?contentType=csv",
                                   "xpath":""},
            "Households_DisposableIncome_Y.csv":{"url":"https://stats.oecd.org/SDMX-JSON/data/DP_LIVE/CZE.HHDI.GROSS.PC_CHGPPCAP.A/OECD?contentType=csv",
                                   "xpath":""},
